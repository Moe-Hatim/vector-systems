    ...
    <section className="section-shell bg-[var(--surface-container-low)]">
      <div className="container-shell space-y-12">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {painPoints.map((item) => (
            <Card key={item.title} className="border-0 bg-[var(--surface-container-lowest)] shadow-[0_8px_20px_rgba(3,22,49,0.04)] transition-transform duration-200 hover:-translate-y-0.5">
